...
public class ModItems {
    ...
    public static final RegistryObject<Item> ITEM_STATUE = ITEMS.register("statue", () -> new BlockItem(ModBlocks.BLOCK_STATUE.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> ITEM_STATUE_OPENED = ITEMS.register("statue_opened", () -> new BlockItem(ModBlocks.BLOCK_STATUE.get(), new Item.Properties().stacksTo(1)));
